...
public class ScissorsCutter : MonoBehaviour
{
    ...
    {
        if(other.TryGetComponent(out ScissorsCutter scirros))
        {
            ScreenSpaceCut(_points[0].position, _points[1].position);
        }
    }
    ...
    private void LateUpdate()
    {
        ...
        lineRenderer.SetPosition(0, _points[0].position);
        lineRenderer.SetPosition(1, _points[1].position);
